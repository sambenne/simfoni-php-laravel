...
use MBLSolutions\InspiredDeckLaravel\Pagination\SimfoniPagination;
use MBLSolutions\Simfoni\Api\ApiResource;
use MBLSolutions\Simfoni\Simfoni;
use MBLSolutions\SimfoniLaravel\Model\Concerns\CanFake;
use MBLSolutions\SimfoniLaravel\Model\Concerns\HasAttributes;

abstract class SimfoniModel
{
    ...
    {
        return $this->resource ?? 'MBLSolutions\Simfoni\\' . substr(strrchr(get_called_class(), "\\"), 1);
    }
    ...
    {
        $paginator = new SimfoniPagination($this->resource());
